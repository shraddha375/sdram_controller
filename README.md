...
Address to Write Delay time(t<sub>AW</sub>) : Specifies the time between the address changing and R/<span style="text-decoration: overline;">W</span>
 input going LOW. 

Write pulse width(t<sub>WP</sub>) : Specifies for how the input data must be present before the R/<span style="text-decoration: overline;">W</span>
